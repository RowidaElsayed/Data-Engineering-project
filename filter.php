...
$brand_nationality = isset($_GET['brand_nationality']) ? $_GET['brand_nationality'] : '';

// Construct the SQL query with filters
$sql = "SELECT * FROM products 
        WHERE price >= :min_price AND price <= :max_price 
        AND brand_name LIKE :brand_name 
        AND brand_nationality LIKE :brand_nationality";
...
$stmt->bindValue(':brand_nationality', '%' . $brand_nationality . '%');
$stmt->execute();
...
<!--==Navigation================================-->
    ...
    <label for="brand_nationality">Brand Nationality:</label>
    <input type="text" name="brand_nationality" id="brand_nationality" value="<?= $brand_nationality ?>">
